...
~ dumb_choice = "{~an idiotic choice|a dumb decision|a rather stupid decision|a hastey choice|not well thought out|not an intelligent choice}" 
...
=2_1_taste
You give the floor a hearty link. It taste salty with a slight burning sensation. Hopefully its nothing too acidic, alkaline, or otherwise poisonous. In retrospect, it wasn't a smart idea to lick an unknown substance. One never knows what sort of tiny creatures cover a surface.
